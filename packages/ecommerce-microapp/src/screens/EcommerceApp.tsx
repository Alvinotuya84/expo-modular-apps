...
import { EcommerceMicroappProvider } from '../components/EcommerceMicroappProvider';

interface EcommerceAppProps extends Partial<MicroappProps> {}

export function EcommerceApp(props: EcommerceAppProps = {}) {
  return (
    <EcommerceMicroappProvider>
      <ScrollView style={styles.container} contentContainerStyle={styles.content}>
        <Text style={styles.title}>Ecommerce Microapp</Text>
        <Text style={styles.subtitle}>This is the ecommerce microapp package</Text>
        
        <View style={styles.infoCard}>
          <Text style={styles.infoTitle}>🎯 Microapp Info</Text>
          <Text style={styles.infoText}>Name: {props.microappName || 'ecommerce'}</Text>
        ...
        <Text style={styles.description}>
          ...
          or used independently in the standalone ecommerce app.
          Start building your ecommerce features here!
        </Text>
      </ScrollView>
    </EcommerceMicroappProvider>
  );
